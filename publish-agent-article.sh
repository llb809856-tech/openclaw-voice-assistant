...
<div style="margin: 25px 0; padding: 15px; background: #f8f9fa; border-radius: 8px; text-align: center;">
<p style="margin: 0; color: #666; font-size: 14px;">💡 配图位置：AI Agent 工作流程图</p>
<p style="margin: 10px 0 0; color: #999; font-size: 13px;">（实际发布时此处可插入流程图或示意图）</p>
</div>
...
<div style="margin: 25px 0; padding: 15px; background: #f8f9fa; border-radius: 8px; text-align: center;">
<p style="margin: 0; color: #666; font-size: 14px;">💡 配图位置：Agent 应用场景示意图</p>
<p style="margin: 10px 0 0; color: #999; font-size: 13px;">（实际发布时此处可插入场景图或案例截图）</p>
</div>
