...
<p style="margin: 12px 0; font-size: 15px; color: #555; line-height: 1.7;">
<strong style="color: #00b894;">亮点：</strong>整合推理、编码和智能体工作流程的最新进展
</p>
</div>
...
<p style="margin: 12px 0; font-size: 15px; color: #555; line-height: 1.7;">
<strong style="color: #f5a623;">深圳站：</strong>腾讯大厦今天搞的免费装龙虾活动，现场人山人海
</p>
<p style="margin: 12px 0; font-size: 15px; color: #555; line-height: 1.7;">
<strong style="color: #f5a623;">纽约站：</strong>Open Claw meetup in NYC last night，座无虚席
</p>
<p style="margin: 12px 0; font-size: 15px; color: #555; line-height: 1.7;">
<strong style="color: #f5a623;">热度：</strong>深圳 41.4 万浏览，纽约 sold out
</p>
<p style="margin: 15px 0 0; font-size: 15px; color: #f5a623; font-weight: 500;">网友：这需求也太高了吧😂😂😂</p>
</div>

<!-- 图 4: OpenClaw NYC -->
<div style="margin: 25px 0; text-align: center;">
<img src="{img4_url}" style="max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);"/>
<p style="margin: 10px 0 0; color: #999; font-size: 13px;">OpenClaw NYC 聚会现场，座无虚席</p>
</div>

<!-- 图 5: 深圳腾讯大厦 -->
<div style="margin: 25px 0; text-align: center;">
<img src="{img5_url}" style="max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);"/>
<p style="margin: 10px 0 0; color: #999; font-size: 13px;">深圳腾讯大厦 OpenClaw 免费装机活动</p>
</div>
...
<p style="margin: 12px 0; font-size: 15px; color: #555; line-height: 1.7;">
<strong style="color: #0066cc;">功能：</strong>以系统应用身份运行，可调用应用、生态能力，也能自主选择系统级工具
</p>
<p style="margin: 12px 0; font-size: 15px; color: #555; line-height: 1.7;">
<strong style="color: #0066cc;">场景：</strong>智能家居控制、晨新闻手机和黄金价格监控等
</p>
<p style="margin: 12px 0; font-size: 15px; color: #555; line-height: 1.7;">
...
<!-- 图 6: 小米 Miclaw -->
<div style="margin: 25px 0; text-align: center;">
<img src="{img6_url}" style="max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);"/>
...
if 'media_id' in result:
    ...
    print(f"👉 内图：5 张（X 热门推文截图）")
    print(f"👉 内容：OpenAI GPT-5.4、OpenClaw 全球火爆、小米 Miclaw")
