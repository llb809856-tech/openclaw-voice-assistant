...
以下文件是核心技能，**不要删除**，但可以修改/更新：

| 文件 | 作用 | 位置 |
|------|------|------|
| **watch-config.js** | 配置文件监控脚本 | `~/.openclaw/config/` |
| **alert-tool.sh** | 工具告警脚本 | `~/.openclaw/config/` |
| **TOOLS-CONFIG.md** | 工具配置备份 | `~/.openclaw/config/` |
| **IMPORTANT-BACKUP.md** | 重要配置备份 | `~/.openclaw/config/` |
